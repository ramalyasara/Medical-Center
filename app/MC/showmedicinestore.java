 ...
 * @author Ramal
 */
public class showmedicinestore extends javax.swing.JFrame {

    /**
     * Creates new form showmedicinestore
     */
    public showmedicinestore() {
        initComponents();
        addvalue();
        addcombo();
        addcombo1();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int weight=Integer.parseInt(wei);
         ...
         DBconnecter db = new DBconnecter();
         if (checkno(quentity) == true && checkno(wei) == true)
        try {
            Connection con = db.getConnection();
            Statement stmt = con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showmedicinestore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
